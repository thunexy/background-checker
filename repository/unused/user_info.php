...
<div class="breadcrumb-box">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="user_info.php?req=<?php $result["user_id"]; ?>">Basic Information</a></li>
                        ...
                        <table class="table table-striped table-bordered text-left my-orders-table">
                            ...
                            <tbody>
                                <?php
                                        ...
                                        echo "<td class='text-center last'><div class='btn-group'><a style='white-space:nowrap' href='company_info.php?req=".$result["user_id"]."' class='btn btn-sm btn-info'>Company Search</a><br/><br/><a style='white-space:nowrap' href='user_info.php?req=".$result["user_id"]."' class='btn btn-sm btn-danger'>Criminal Records</a></div></td>";
                                        echo "</tr>";
                                ?>
                            </tbody>
                        </table>
