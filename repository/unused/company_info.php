        ...
        <div class="breadcrumb-box">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><a href="company_info.php?req=<?php $result["user_id"]; ?>">Company Information</a></li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered text-left my-orders-table">
                                    ...
                                    <?php
                                        ...
                                        echo "<td>". $result["certificate_no"] ."</td>";
                                        echo "<td>". $result["doi"] ."</td>";
                                        echo "<td>". $result["countersignatory_details"] ."</td>";
                                        echo "<td>". $result["employer"] ."</td>";
                                        echo "<td>". $result["position"] ."</td>";
                                        echo "<td>". $result["employment_details"] ."</td>";
                                        echo "<td class='text-center last'><div class='btn-group'><a style='white-space:nowrap' href='user_info.php?req=".$result["user_id"]."' class='btn btn-sm btn-info'>Basic Information</a><br/><br/><a style='white-space:nowrap' href='user_info.php?req=".$result["user_id"]."' class='btn btn-sm btn-danger'>Criminal Records</a></div></td>";
                                        echo "</tr>";
                                    ?>
                                    </tbody>
                                </table>
