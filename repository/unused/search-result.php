...
<div class="breadcrumb-box">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="search-result.php">Results</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12" style="margin-bottom: 30px">
                <h2>Individual Search Results</h2>
                            ...
                            <tbody>
                                ...
                                if($resultSize == 0){
                                    ...
                                    for($i=0; $i < $resultSize; $i++){
                                        ...
                                        echo "<td>". Session::sessionArray("results")[$i]["dob"] ."</td>";
                                        echo "<td>". Session::sessionArray("results")[$i]["gender"] ."</td>";
                                        echo "<td>". Session::sessionArray("results")[$i]["postcode"] ."</td>";
                                        echo "<td>". Session::sessionArray("results")[$i]["address"] ."</td>";
                                        echo "<td class='text-center last'><div class='btn-group'><a style='white-space:nowrap' href='company_info.php?req=".Session::sessionArray("results")[$i]["user_id"]."' class='btn btn-sm btn-info'>Company Search</a><br/><br/><a style='white-space:nowrap' href='user_info.php?req=".Session::sessionArray("results")[$i]["user_id"]."' class='btn btn-sm btn-danger'>Criminal Records</a></div></td>";
                                        echo "</tr>";
                                    }
                                }
                                ?>
