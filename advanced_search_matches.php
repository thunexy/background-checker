                        ...
                        <table class="table table-striped table-bordered text-left my-orders-table" style="background: #fff">
                            ...
                            if($resultSize == 0){
                                ...
                                foreach(Session::sessionArray("results") as $key=>$value){
                                    ...
                                    echo "<td class='text-center last'><div class='btn-group'><a style='white-space:nowrap' href='app.php?advanced-search-result&req=".$value["user_id"]."' class='btn btn-sm btn-info'>View Profile</a></div></td>";
                                    echo "</tr>";
                                    $i++;
                                }
                            }
